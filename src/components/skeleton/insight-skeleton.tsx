function CardSkeleton() {
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-700 dark:bg-gray-900">
      ...
      <div className="mt-3 h-7 w-28 animate-pulse rounded bg-gray-200 dark:bg-gray-700" />
      <div className="mt-2 h-3 w-36 animate-pulse rounded bg-gray-200 dark:bg-gray-700" />
    </div>
  );
}
...
function ChartSkeleton() {
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-700 dark:bg-gray-900">
      ...
      <div className="mt-4 h-72 animate-pulse rounded bg-gray-100 dark:bg-gray-800" />
    </div>
  );
}
